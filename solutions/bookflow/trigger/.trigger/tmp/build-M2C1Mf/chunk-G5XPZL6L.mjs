...
async function generateJWT(options) {
  const { SignJWT } = await import("./esm-GQOKZXQA.mjs");
...
async function randomUUID() {
  const { randomUUID: randomUUID2 } = await import("./crypto.node-MFOIADBH.mjs");
  return randomUUID2();
}
__name(randomUUID, "randomUUID");
async function digestSHA256(data) {
  const { subtle: subtle2 } = await import("./crypto.node-MFOIADBH.mjs");
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-G5XPZL6L.mjs.map
