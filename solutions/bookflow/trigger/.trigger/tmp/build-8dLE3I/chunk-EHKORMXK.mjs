...
var require_src2 = __commonJS({
  "node_modules/@google-cloud/precise-date/build/src/index.js"(exports) {
    ...
    function padLeft(n2, min) {
      const padding2 = getPadding(n2, min);
      return `${padding2}${n2}`;
    }
...
var __read2, __spreadArray2, API_NAME4, DiagAPI;
var init_diag = __esm({
  "node_modules/@opentelemetry/api/build/esm/api/diag.js"() {
    init_esm();
...
var __read5, __spreadArray4, API_NAME5, NOOP_CONTEXT_MANAGER, ContextAPI;
  ...
  "node_modules/@opentelemetry/api/build/esm/api/context.js"() {
    ...
    function() {
      ...
      ContextAPI2.prototype.setGlobalContextManager = function(contextManager) {
        return registerGlobal2(API_NAME5, contextManager, DiagAPI.instance());
      };
      ...
      ContextAPI2.prototype._getContextManager = function() {
        return getGlobal2(API_NAME5) || NOOP_CONTEXT_MANAGER;
      };
  ...
  "node_modules/@opentelemetry/api/build/esm/api/metrics.js"() {
    ...
    function() {
      ...
      MetricsAPI2.prototype.setGlobalMeterProvider = function(provider) {
        return registerGlobal2(API_NAME6, provider, DiagAPI.instance());
      };
      MetricsAPI2.prototype.getMeterProvider = function() {
        return getGlobal2(API_NAME6) || NOOP_METER_PROVIDER;
      };
...
var API_NAME7, NOOP_TEXT_MAP_PROPAGATOR, PropagationAPI;
  ...
  "node_modules/@opentelemetry/api/build/esm/api/propagation.js"() {
    ...
    function() {
      ...
      PropagationAPI2.prototype.setGlobalPropagator = function(propagator) {
        return registerGlobal2(API_NAME7, propagator, DiagAPI.instance());
      };
      ...
      PropagationAPI2.prototype._getGlobalPropagator = function() {
        return getGlobal2(API_NAME7) || NOOP_TEXT_MAP_PROPAGATOR;
      };
  ...
  "node_modules/@opentelemetry/api/build/esm/api/trace.js"() {
    ...
    function() {
      ...
      TraceAPI2.prototype.setGlobalTracerProvider = function(provider) {
        var success = registerGlobal2(API_NAME8, this._proxyTracerProvider, DiagAPI.instance());
        if (success) {
      ...
      TraceAPI2.prototype.disable = function() {
        unregisterGlobal2(API_NAME8, DiagAPI.instance());
        this._proxyTracerProvider = new ProxyTracerProvider();
      };
      return TraceAPI2;
    }();
...
var require_merge = __commonJS({
  "node_modules/@opentelemetry/core/build/src/utils/merge.js"(exports) {
    ...
    function isObject(value) {
      return !isPrimitive2(value) && !isArray3(value) && !isFunction(value) && typeof value === "object";
    }
...
var require_humanize_duration = __commonJS({
  "node_modules/humanize-duration/humanize-duration.js"(exports, module) {
    ...
    (function() {
      ...
      __name(romanianUnit, "romanianUnit");
...
async function generateJWT(options) {
  const { SignJWT } = await import("./esm-LXB6O3LJ.mjs");
...
var TriggerTaskRequestBody = external_exports.object({
  ...
  options: external_exports.object({
    ...
    debounce: external_exports.object({
      ...
      maxDelay: external_exports.string().optional()
    }).optional()
  }).optional()
});
...
var BuildServerMetadata = external_exports.object({
  ...
  skipEnqueue: external_exports.boolean().optional()
});
...
var InitializeDeploymentRequestBodyBase = external_exports.object({
  contentHash: external_exports.string(),
  ...
  isLocalBuild: external_exports.boolean().optional(),
  triggeredVia: DeploymentTriggeredVia.optional(),
  buildId: external_exports.string().optional()
});
var InitializeDeploymentRequestBodyFull = InitializeDeploymentRequestBodyBase.extend({
  isNativeBuild: external_exports.boolean().default(false),
  skipPromotion: external_exports.boolean().optional(),
  artifactKey: external_exports.string().optional(),
  configFilePath: external_exports.string().optional(),
  skipEnqueue: external_exports.boolean().optional().default(false)
});
var InitializeDeploymentRequestBody = InitializeDeploymentRequestBodyFull.transform((data) => {
...
var GetDeploymentResponseBody = external_exports.object({
  ...
  imagePlatform: external_exports.string(),
  commitSHA: external_exports.string().nullish(),
  externalBuildData: ExternalBuildData.optional().nullable(),
  ...
  integrationDeployments: external_exports.array(external_exports.object({
    id: external_exports.string(),
    integrationName: external_exports.string(),
    integrationDeploymentId: external_exports.string(),
...
var ImportEnvironmentVariablesRequestBody = external_exports.object({
  ...
  source: external_exports.discriminatedUnion("type", [
    external_exports.object({ type: external_exports.literal("user"), userId: external_exports.string() }),
    external_exports.object({ type: external_exports.literal("integration"), integration: external_exports.string() })
  ]).optional()
});
...
var WorkerToExecutorMessageCatalog = {
  ...
  FLUSH: {
    message: external_exports.object({
      ...
      disableContext: external_exports.boolean().optional()
    }),
...
// node_modules/@trigger.dev/core/dist/esm/v3/schemas/query.js
init_esm();
var QueryExecuteRequestBody = external_exports.object({
  query: external_exports.string(),
  scope: external_exports.enum(["organization", "project", "environment"]).default("environment"),
  period: external_exports.string().nullish(),
  from: external_exports.string().nullish(),
  to: external_exports.string().nullish(),
  format: external_exports.enum(["json", "csv"]).default("json")
});
var QueryExecuteJSONResponseBody = external_exports.object({
  format: external_exports.literal("json"),
  results: external_exports.array(external_exports.record(external_exports.any()))
});
var QueryExecuteCSVResponseBody = external_exports.object({
  format: external_exports.literal("csv"),
  results: external_exports.string()
});
var QueryExecuteResponseBody = external_exports.discriminatedUnion("format", [
...
var TaskContextAPI = class _TaskContextAPI {
  ...
  setGlobalTaskContext(taskContext2) {
    ...
    return registerGlobal(API_NAME3, taskContext2, true);
  }
  #getTaskContext() {
...
function calculateNextRetryDelay(options, attempt) {
  ...
  const random2 = randomize ? Math.random() + 1 : 1;
  const timeout3 = Math.min(maxTimeoutInMs, random2 * minTimeoutInMs * Math.pow(factor, attempt - 1));
...
var BatchNotSealedError = class extends Error {
  static {
    __name(this, "BatchNotSealedError");
  }
...
async function randomUUID() {
  const { randomUUID: randomUUID2 } = await import("./crypto.node-VB5YUPXH.mjs");
  return randomUUID2();
}
__name(randomUUID, "randomUUID");
async function digestSHA256(data) {
  const { subtle: subtle2 } = await import("./crypto.node-VB5YUPXH.mjs");
...
// node_modules/@trigger.dev/core/dist/esm/v3/imports/superjson.js
init_esm();

// node_modules/@trigger.dev/core/dist/esm/v3/vendor/superjson.mjs
init_esm();
...
var getNthKey = /* @__PURE__ */ __name((value, n2) => {
...
function isOneOf(a2, b2, c2, d2, e) {
  return (value) => a2(value) || b2(value) || !!c2 && c2(value) || !!d2 && d2(value) || !!e && e(value);
}
...
__name(shouldRetryStreamBatchItems, "shouldRetryStreamBatchItems");
function sleep(ms) {
...
__name(safeStreamCancel, "safeStreamCancel");
...
__name(createNdjsonStream, "createNdjsonStream");
...
// node_modules/@trigger.dev/core/dist/esm/v3/idempotency-key-catalog-api.js
init_esm();

// node_modules/@trigger.dev/core/dist/esm/v3/idempotency-key-catalog/index.js
init_esm();

// node_modules/@trigger.dev/core/dist/esm/v3/idempotency-key-catalog/lruIdempotencyKeyCatalog.js
init_esm();
var LRUIdempotencyKeyCatalog = class {
  static {
    __name(this, "LRUIdempotencyKeyCatalog");
  }
  cache;
  maxSize;
...
// node_modules/@trigger.dev/core/dist/esm/v3/idempotency-key-catalog/index.js
var API_NAME22 = "idempotency-key-catalog";
var IdempotencyKeyCatalogAPI = class _IdempotencyKeyCatalogAPI {
  static {
    __name(this, "IdempotencyKeyCatalogAPI");
  }
  static _instance;
  constructor() {
  }
  ...
  #getCatalog() {
    let catalog = getGlobal(API_NAME22);
    if (!catalog) {
      catalog = new LRUIdempotencyKeyCatalog();
      registerGlobal(API_NAME22, catalog, true);
    }
    return catalog;
  }
};
...
__name(getIdempotencyKeyOptions, "getIdempotencyKeyOptions");
...
// node_modules/@trigger.dev/core/dist/esm/v3/isomorphic/friendlyId.js
init_esm();
...
// node_modules/@bugsnag/cuid/lib/fingerprint.mjs
init_esm();
...
function createCuid(fingerprint2) {
  ...
  __name(randomBlock, "randomBlock");
  function safeCounter() {
    c2 = c2 < discreteValues ? c2 : 0;
    c2++;
    return c2 - 1;
  }
  __name(safeCounter, "safeCounter");
  function cuid2() {
...
// node_modules/@trigger.dev/core/dist/esm/v3/isomorphic/friendlyId.js
var idGenerator = customAlphabet("123456789abcdefghijkmnopqrstuvwxyz", 21);
function generateInternalId() {
  return index_esm_default();
}
__name(generateInternalId, "generateInternalId");
...
__name(toFriendlyId, "toFriendlyId");
...
__name(fromFriendlyId, "fromFriendlyId");
var IdUtil = class {
  static {
    __name(this, "IdUtil");
  }
...
var BackgroundWorkerId = new IdUtil("worker");
var CheckpointId = new IdUtil("checkpoint");
var QueueId = new IdUtil("queue");
var RunId = new IdUtil("run");
var SnapshotId = new IdUtil("snapshot");
var WaitpointId = new IdUtil("waitpoint");
var BatchId = new IdUtil("batch");
var BulkActionId = new IdUtil("bulk");
var AttemptId = new IdUtil("attempt");
...
__name(getSchemaParseFn, "getSchemaParseFn");
...
@google-cloud/precise-date/build/src/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-EHKORMXK.mjs.map
