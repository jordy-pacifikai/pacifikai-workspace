...
export function TopBar({ title, notificationCount = 0 }: TopBarProps) {
  ...
  return (
    <header
      className="fixed top-0 left-64 right-0 h-16 flex items-center justify-between px-6 z-30 border-b border-gray-800"
      style={{
    ...
    >
      ...
      <div className="flex items-center gap-3">
        {/* Today badge */}
        <span className="hidden sm:inline-flex items-center px-3 py-1.5 rounded-lg bg-gray-800/80 border border-gray-700 text-xs text-gray-400 font-medium">
          {todayFormatted}
        </span>
