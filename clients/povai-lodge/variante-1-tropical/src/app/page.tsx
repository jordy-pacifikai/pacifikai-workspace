        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="max-w-2xl">
            <div className="animate-fade-in-down">
              <span className="inline-block text-turquoise-300 text-sm tracking-[0.3em] uppercase mb-4 font-medium">
            ...
            >
              <Link
                href="/reservation"
                className="bg-turquoise-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-turquoise-600 transition-all duration-300 hover:scale-105 shadow-lg shadow-turquoise-500/25"
              >
                {t.hero.cta}
              </Link>
              <Link
      ...
      <div ref={sectionRef}>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-center">
              {[
                ...
                <div key={stat.label} className="animate-on-scroll">
                  <p className="font-serif text-3xl sm:text-4xl font-bold text-turquoise-500">
                    {stat.value}
                  </p>
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mt-12 animate-on-scroll">
              <Link
                href="/chambres"
                className="inline-flex items-center gap-2 text-turquoise-500 font-semibold hover:text-turquoise-600 transition-colors group"
              >
                {t.rooms.viewAll}
                <svg
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div className="animate-on-scroll">
                ...
                <Link
                  href="/lodge"
                  className="inline-flex items-center gap-2 bg-tropical-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-tropical-600 transition-colors"
                >
        ...
        <section className="relative py-32 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-4 text-center animate-on-scroll">
            ...
            <Link
              href="/reservation"
              className="inline-block bg-white text-turquoise-500 px-10 py-4 rounded-full text-lg font-bold hover:bg-sand-100 transition-all duration-300 hover:scale-105 shadow-xl"
            >
              {t.hero.cta}
            </Link>
          </div>
