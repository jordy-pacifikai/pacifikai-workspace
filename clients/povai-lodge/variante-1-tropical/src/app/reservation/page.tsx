    ...
    <>
      ...
      <section className="relative h-[40vh] min-h-[300px] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            src="/images/povai-chambre-moana.png"
            alt="Reservation"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="font-serif text-4xl sm:text-5xl text-white font-bold animate-fade-in-up">
            {t.reservation.title}
          </h1>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
                  ...
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-all ${
                      step > i + 1
                        ...
                        : step === i + 1
                        ? "bg-turquoise-500 text-white scale-110"
                ...
                {i < 3 && (
                  <div
                    className={`flex-1 h-0.5 mx-2 transition-colors ${
                      step > i + 1 ? "bg-tropical-500" : "bg-gray-200"
                    }`}
                  />
                )}
              </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl border-2 transition-all text-left ${
                    selectedRoomId === room.id
                      ...
                      : "border-gray-200 bg-white hover:border-turquoise-300"
                  }`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-serif text-lg font-bold text-gray-900">{room.name}</h3>
                    <p className="text-gray-500 text-sm truncate">
                      {room.capacity} {t.rooms.persons} &middot; {room.size} &middot; {lang === "fr" ? room.bedTypeFr : room.bedType}
                    </p>
                    <p className="text-turquoise-500 font-semibold mt-1">{room.priceLabel}</p>
                  </div>
                  <div
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    } focus:ring-2 focus:ring-turquoise-500 focus:border-transparent outline-none transition`}
                  />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-turquoise-500 focus:border-transparent outline-none transition bg-white"
                >
              ...
              {nights > 0 && selectedRoom && (
                <div className="bg-turquoise-50 rounded-xl p-4">
                  ...
                  <div className="flex justify-between font-serif text-lg font-bold text-turquoise-600 pt-2 border-t border-turquoise-200">
                    <span>Total</span>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-turquoise-500 focus:border-transparent outline-none transition resize-none"
                />
              </div>

              {/* Summary */}
              <div className="bg-turquoise-50 rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between font-serif text-lg font-bold text-turquoise-600 pt-3 border-t border-turquoise-200 mt-3">
          ...
          {step === 4 && confirmed && (
            <div className="text-center py-12">
              <div className="w-20 h-20 rounded-full bg-tropical-500 flex items-center justify-center mx-auto mb-6 animate-scale-in">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h2 className="font-serif text-3xl font-bold text-gray-900 mb-4 animate-fade-in-up">
              ...
              <div className="animate-fade-in-up bg-white rounded-xl p-6 max-w-md mx-auto shadow-sm border border-gray-100 mb-8" style={{ animationDelay: "400ms" }}>
                <div className="space-y-2 text-sm text-left">
                  ...
                  <div className="flex justify-between pt-2 border-t font-bold text-turquoise-600">
                    <span>Total</span>
                    <span>{totalPrice.toLocaleString()} XPF</span>
                  </div>
                </div>
              ...
              <button
                onClick={resetForm}
                className="bg-turquoise-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-turquoise-600 transition-colors animate-fade-in-up"
          ...
          {!confirmed && (
            <div className="flex justify-between mt-10">
              ...
              {step < 3 ? (
                <button
                  onClick={handleNext}
                  className="flex items-center gap-2 bg-turquoise-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-turquoise-600 transition-all duration-300 hover:scale-105"
                >
                  {t.reservation.next}
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-tropical-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-tropical-600 transition-all duration-300 hover:scale-105"
                >
