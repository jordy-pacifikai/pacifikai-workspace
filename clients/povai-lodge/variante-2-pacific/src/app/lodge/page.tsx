          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="animate-on-scroll relative">
                ...
                <div className="absolute -bottom-6 -left-6 bg-ocean-500 text-white p-6 rounded-2xl shadow-xl">
              ...
              {activities.map((activity, i) => (
                ...
                >
                  <div className="relative h-52 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-ocean-600 text-xs font-bold px-3 py-1 rounded-full">
                      {activity.duration}
                    </div>
                  </div>
                  <div className="p-6">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-4 text-center animate-on-scroll">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="/reservation"
                className="bg-white text-ocean-500 px-8 py-4 rounded-full text-lg font-bold hover:bg-offwhite-100 transition-all hover:scale-105 shadow-xl"
              >
                {t.hero.cta}
              </Link>
              <Link
