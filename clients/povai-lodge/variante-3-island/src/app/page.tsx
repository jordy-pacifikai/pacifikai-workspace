...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section ref={heroRef} className="relative min-h-dvh flex items-center overflow-hidden">
        <div className="hero-bg absolute inset-0 will-change-transform">
          <Image
            src="https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=1920&q=80"
            alt="Bora Bora sunset beach"
            fill
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#264653]/40 via-transparent to-[#E76F51]/30" />

        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          <div className="max-w-2xl">
            <div className="animate-fade-in-down">
              <span className="inline-block text-sunset-300 text-sm tracking-[0.3em] uppercase mb-4 font-medium">
                Bora Bora, Polynesie francaise
              </span>
            </div>
            <h1 className="animate-fade-in-up font-serif text-4xl sm:text-5xl lg:text-7xl text-white font-bold leading-[1.1] mb-6">
              {t.hero.title}
            </h1>
            <p
              className="animate-fade-in-up text-white/85 text-lg sm:text-xl leading-relaxed mb-10 max-w-lg"
            ...
            >
              <Link
                href="/reservation"
                className="bg-sunset-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-sunset-600 transition-all duration-300 hover:scale-105 shadow-lg shadow-sunset-500/25"
              >
                {t.hero.cta}
              </Link>
              <Link
                href="/chambres"
                className="border-2 border-white/50 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-white/10 transition-all duration-300"
              >
                {t.hero.discover}
              </Link>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 sm:gap-16 text-center">
              {[
                ...
                <div key={stat.label} className="animate-on-scroll">
                  <p className="font-serif text-3xl sm:text-4xl font-bold text-sunset-500">
                    {stat.value}
                  </p>
        ...
        <section className="py-20 sm:py-28">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16 animate-on-scroll">
              <span className="text-sunset-500 text-sm tracking-[0.2em] uppercase font-medium">
            ...
            <div className="text-center mt-12 animate-on-scroll">
              <Link
                href="/chambres"
                className="inline-flex items-center gap-2 text-sunset-500 font-semibold hover:text-sunset-600 transition-colors group"
              >
                {t.rooms.viewAll}
                <svg
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div className="animate-on-scroll">
                ...
                <Link
                  href="/lodge"
                  className="inline-flex items-center gap-2 bg-deep-500 text-white px-6 py-3 rounded-full font-semibold hover:bg-deep-600 transition-colors"
                >
        ...
        <section className="relative py-32 overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              sizes="100vw"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-sunset-500/80 to-deep-500/80" />
          </div>
          <div className="relative z-10 max-w-3xl mx-auto px-4 text-center animate-on-scroll">
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl text-white font-bold mb-6">
            ...
            <Link
              href="/reservation"
              className="inline-block bg-white text-sunset-500 px-10 py-4 rounded-full text-lg font-bold hover:bg-cream-100 transition-all duration-300 hover:scale-105 shadow-xl"
            >
              {t.hero.cta}
            </Link>
          </div>
