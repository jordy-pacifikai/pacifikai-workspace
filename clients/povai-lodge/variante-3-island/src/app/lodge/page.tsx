    ...
    <>
      ...
      <div ref={sectionRef}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div className="grid grid-cols-2 gap-6">
                  {[
                    ...
                    <div key={item.label} className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-sunset-100 flex items-center justify-center shrink-0">
                        <svg className="w-5 h-5 text-sunset-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="animate-on-scroll relative">
                <div className="relative h-[500px] rounded-2xl overflow-hidden">
                  <Image
                    src="https://images.unsplash.com/photo-1602002418816-5c0aeef426aa?w=800&q=80"
                    alt="Povai Lodge"
                    fill
                    className="object-cover"
                ...
                <div className="absolute -bottom-6 -left-6 bg-sunset-500 text-white p-6 rounded-2xl shadow-xl">
                  <p className="font-serif text-3xl font-bold">10+</p>
                  <p className="text-sm text-sunset-100">
              ...
              {activities.map((activity, i) => (
                ...
                >
                  <div className="relative h-52 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm text-sunset-600 text-xs font-bold px-3 py-1 rounded-full">
                      {activity.duration}
                    </div>
                  </div>
                  <div className="p-6">
        ...
        <section className="relative py-24 overflow-hidden">
          <div className="absolute inset-0">
            <Image
              src="https://images.unsplash.com/photo-1530053969600-caed2596d242?w=1920&q=80"
              alt="Bora Bora water"
              fill
              className="object-cover"
              sizes="100vw"
          ...
          <div className="relative z-10 max-w-3xl mx-auto px-4 text-center animate-on-scroll">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <Link
                href="/reservation"
                className="bg-white text-sunset-500 px-8 py-4 rounded-full text-lg font-bold hover:bg-cream-100 transition-all hover:scale-105 shadow-xl"
              >
                {t.hero.cta}
              </Link>
              <Link
