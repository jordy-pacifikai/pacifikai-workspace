        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
                ...
                {i < 3 && (
                  <div
                    className={`flex-1 h-0.5 mx-2 transition-colors ${
                      step > i + 1 ? "bg-deep-500" : "bg-gray-200"
                    }`}
                  />
                )}
              </div>
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-4 p-4 rounded-xl border-2 transition-all text-left ${
                    selectedRoomId === room.id
                      ...
                      : "border-gray-200 bg-white hover:border-sunset-300"
                  }`}
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sunset-500 font-semibold mt-1">{room.priceLabel}</p>
                  </div>
                  <div
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    } focus:ring-2 focus:ring-sunset-500 focus:border-transparent outline-none transition`}
                  />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-sunset-500 focus:border-transparent outline-none transition bg-white"
                >
              ...
              {nights > 0 && selectedRoom && (
                <div className="bg-sunset-50 rounded-xl p-4">
                  ...
                  <div className="flex justify-between font-serif text-lg font-bold text-sunset-600 pt-2 border-t border-sunset-200">
                    <span>Total</span>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-sunset-500 focus:border-transparent outline-none transition resize-none"
                />
              </div>

              {/* Summary */}
              <div className="bg-sunset-50 rounded-xl p-6">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between font-serif text-lg font-bold text-sunset-600 pt-3 border-t border-sunset-200 mt-3">
          ...
          {step === 4 && confirmed && (
            <div className="text-center py-12">
              <div className="w-20 h-20 rounded-full bg-deep-500 flex items-center justify-center mx-auto mb-6 animate-scale-in">
              ...
              <div className="animate-fade-in-up bg-white rounded-xl p-6 max-w-md mx-auto shadow-sm border border-gray-100 mb-8" style={{ animationDelay: "400ms" }}>
                <div className="space-y-2 text-sm text-left">
                  ...
                  <div className="flex justify-between pt-2 border-t font-bold text-sunset-600">
                    <span>Total</span>
                    <span>{totalPrice.toLocaleString()} XPF</span>
                  </div>
                </div>
              ...
              <button
                onClick={resetForm}
                className="bg-sunset-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-sunset-600 transition-colors animate-fade-in-up"
          ...
          {!confirmed && (
            <div className="flex justify-between mt-10">
              ...
              {step < 3 ? (
                <button
                  onClick={handleNext}
                  className="flex items-center gap-2 bg-sunset-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-sunset-600 transition-all duration-300 hover:scale-105"
                >
                  {t.reservation.next}
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className="flex items-center gap-2 bg-deep-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-deep-600 transition-all duration-300 hover:scale-105"
                >
