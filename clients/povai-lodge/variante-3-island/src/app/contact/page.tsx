          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-3 animate-on-scroll">
                {sent ? (
                  <div className="text-center py-16">
                    <div className="w-16 h-16 rounded-full bg-deep-500 flex items-center justify-center mx-auto mb-6 animate-scale-in">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-sunset-500 focus:border-transparent outline-none transition"
                        />
                      </div>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">
                    ...
                    <button
                      type="submit"
                      className="w-full sm:w-auto bg-sunset-500 text-white px-10 py-4 rounded-full text-lg font-semibold hover:bg-sunset-600 transition-all duration-300 hover:scale-105"
                    >
                      {t.contact.send}
                    </button>
                  </form>
              ...
              <div className="lg:col-span-2 animate-on-scroll">
                <div className="bg-cream-100 rounded-2xl p-8 space-y-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start gap-4">
                      <div className="w-12 h-12 rounded-full bg-sunset-100 flex items-center justify-center shrink-0">
                      ...
                      <div>
                        ...
                        <a href="tel:+68989538387" className="text-sunset-500 hover:text-sunset-600 transition-colors">
                          +689 89 53 83 87
                        </a>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a href="mailto:contact@povailodge.com" className="text-sunset-500 hover:text-sunset-600 transition-colors">
                    ...
                    <div className="flex gap-3">
                      {[
                        ...
                        <a
                          key={social.name}
                          href="#"
                          className="w-10 h-10 rounded-full bg-sunset-500 flex items-center justify-center hover:bg-sunset-600 transition-colors text-white"
