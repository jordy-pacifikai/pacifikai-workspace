        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-16">
            ...
            <div className="space-y-6">
              ...
              <div className="gsap-reveal p-8 bg-navy-50/40 border border-navy-100/30 rounded-3xl">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-navy">LinkedIn</p>
                      <a
                        href="https://linkedin.com/company/pacificblueconsulting"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-sm text-steel hover:text-gold transition-colors duration-300"
                      >
              ...
              <div className="gsap-reveal p-8 bg-navy-50/40 border border-navy-100/30 rounded-3xl">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    <span className="text-warm">Lundi - Vendredi</span>
                    <span className="font-medium text-navy">8h00 - 17h00</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-warm">Samedi - Dimanche</span>
                    <span className="font-medium text-warm-400">Ferme</span>
                  </div>
                </div>
              ...
              {/* Map */}
              <div className="gsap-reveal rounded-3xl overflow-hidden border border-navy-100/30">
                <div className="aspect-[4/3] bg-gradient-to-br from-navy-50 to-navy-100/50 flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-14 h-14 bg-navy-100/50 rounded-2xl flex items-center justify-center mx-auto">
                      <svg className="w-7 h-7 text-steel" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                        <path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                        <path d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                      </svg>
                    </div>
                    <p className="mt-4 text-sm font-semibold text-navy">Punaauia, Tahiti</p>
                    <p className="text-xs text-warm mt-1">Polynesie francaise</p>
                    <a
                      href="https://www.google.com/maps/search/Punaauia+Tahiti"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-4 inline-flex items-center text-xs font-medium text-steel hover:text-gold transition-colors duration-300 group"
                    >
