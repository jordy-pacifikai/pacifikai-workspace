      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="w-10 h-10 bg-white/[0.06] border border-white/[0.08] rounded-xl flex items-center justify-center group-hover:border-teal/20 transition-colors duration-300">
                <svg
                  viewBox="0 0 24 24"
                  fill="none"
          ...
          {/* Expertise */}
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.25em] text-teal mb-5">
              Expertise
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/40">
              <li className="flex items-start gap-3">
                <svg className="w-4 h-4 mt-0.5 text-teal/60 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
              ...
              <li>
                <a href="tel:+68987747284" className="flex items-center gap-3 hover:text-white transition-colors duration-300">
                  <svg className="w-4 h-4 text-teal/60 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <div className="border-t border-white/[0.06] py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/20 text-xs">
            Punaauia, Tahiti &mdash; Polynesie francaise
          </p>
        </div>
      </div>
    </footer>
