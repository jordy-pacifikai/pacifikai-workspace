                ...
                >
                  ...
                  <div className="p-7">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <span className="shrink-0 text-xs text-warm bg-navy-50/70 px-3 py-1.5 rounded-lg font-medium">
                        {mission.duration}
                      </span>
                    </div>
                  ...
                  >
                    <div className="px-7 pb-6">
                      <div className="pt-4 border-t border-navy-100/30">
                        <p className="text-sm text-warm leading-relaxed mb-5">
                          {mission.description}
                        </p>
                        <div>
                          ...
                          <ul className="space-y-2.5">
                            {mission.results.map((result) => (
                              <li key={result} className="flex items-start gap-2.5 text-sm text-warm">
                                <svg
                  ...
                  <button
                    ...
                    className="w-full px-7 py-3.5 border-t border-navy-100/30 bg-navy-50/30 text-sm font-medium text-steel hover:text-gold transition-all duration-300 flex items-center justify-center gap-2"
