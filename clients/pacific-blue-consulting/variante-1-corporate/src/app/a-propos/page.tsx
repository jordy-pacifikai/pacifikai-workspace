...
function TerritoryCard({ territory }: { territory: typeof territories[0] }) {
  ...
  return (
    <div className="card-hover p-8 bg-white/[0.04] backdrop-blur-sm border border-white/[0.08] rounded-3xl">
      <span ref={ref} className="block font-display text-fluid-4xl font-bold text-gold">
        0{territory.suffix}
      </span>
              ...
              <div className="gsap-reveal-scale">
                <div className="aspect-[3/4] bg-gradient-to-br from-navy-50 to-navy-100/50 rounded-3xl flex items-center justify-center overflow-hidden relative">
                  ...
                  <div className="text-center p-8 relative z-10">
                    <div className="w-32 h-32 bg-navy-100 rounded-full mx-auto flex items-center justify-center border-2 border-navy-200/50">
                      <svg className="w-16 h-16 text-steel" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
                    ...
                    <p className="mt-1 text-sm text-steel font-medium">
                      Fondateur & Directeur
                    </p>
                    ...
                    <a
                      ...
                      className="mt-5 inline-flex items-center gap-2 text-sm text-steel hover:text-gold transition-colors duration-300"
                    >
