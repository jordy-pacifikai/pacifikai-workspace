...
export type Client = {
  ...
  logo?: string;
  // Texte affiche en hover si renseigne, sinon name
  hoverLabel?: string;
};
...
export const clients: Client[] = [
  ...
  { name: "Air Bora Bora", category: "compagnies", logo: "/images/logos/air-bora-bora.png" },
  { name: "Islands Airline", category: "compagnies", logo: "/images/logos/islands-airline.png" },
  { name: "IAS", category: "compagnies", logo: "/images/logos/ias.png", hoverLabel: "Islands Air Services" },
  ...
  { name: "Aéroport de Tahiti", category: "grands-groupes", logo: "/images/logos/adt.png" },
  ...
  { name: "Etik Pf", category: "grands-groupes", logo: "/images/logos/etik-pf.png" },
  // Formation
