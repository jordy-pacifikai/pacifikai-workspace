        ...
        <div className="py-16 lg:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <ul className="space-y-3">
              {offresLinks.map((link) => (
                <li key={link.href}>
                  <Link
                    href={link.href}
                    className="inline-flex items-center min-h-[40px] py-1.5 text-white/40 text-sm hover:text-white transition-colors duration-300"
                  >
                    {tLinks(link.key)}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-white/40">
              ...
              <li>
                <a href="tel:+68987747284" className="flex items-center gap-3 min-h-[40px] py-1.5 hover:text-white transition-colors duration-300">
              ...
              <li>
                <a href="mailto:contact@pacificblueconsulting.org" className="flex items-center gap-3 min-h-[40px] py-1.5 hover:text-white transition-colors duration-300 break-all">
                  <svg className="w-4 h-4 text-gold/60 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
            ...
            <a
              ...
              className="mt-6 inline-flex items-center gap-2 min-h-[40px] px-4 py-2.5 bg-white/[0.04] border border-white/[0.06] rounded-lg text-sm text-white/50 hover:text-white hover:border-white/15 transition-all duration-300"
            >
        ...
        <div className="border-t border-white/[0.06] py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-white/30 text-xs">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block py-1 text-gold/80 hover:text-gold transition-colors duration-300 font-medium"
            >
              PACIFIK&apos;AI
            </a>
          </p>
