...
class SupabaseClient {
    ...
    async getProjects() {
        return await this.select('projects', {}, { order: 'created_at.desc' });
    }
    ...
    async createProject(data) {
        const result = await this.insert('projects', data);
    ...
    async updateProspectProject(prospectId, projectId, table = 'prospects') {
        return await this.update(table, prospectId, { project_id: projectId });
    }

    async getTasksByProject(projectId) {
        return await this.select('tasks', { project_id: `eq.${projectId}` }, { order: 'created_at.desc' });
    }

    async getCrmTasksByProject(projectId) {
        return await this.select('crm_tasks', { project_id: `eq.${projectId}` }, { order: 'created_at.desc' });
    }
